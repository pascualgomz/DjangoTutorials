...
from .views import HomePageView, AboutPageView, ContactPageView, ProductIndexView, ProductShowView, ProductCreateView, ProductCreatedPageView, CartView, CartRemoveAllView, ImageViewFactory, ImageViewNoDI
...
urlpatterns = [ 
    ...
    path('created', ProductCreatedPageView.as_view(), name='created'),
